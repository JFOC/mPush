//var pushData = //[//{ pushmessage: [
		  //{message: "this is a message", badgeNumber: "2", actionText: "Buy Now!", deviceID: "ea69617d0b24f5d9e42bf4b071fb7c6c68b4892392aa981a84a12459e1ce73d4" },
	//	  {message: "holy moly miss moly", actionText: "View Special Offers", appid: "devtest" }
		//]};
...
$(function() {
	...
	$("#saveSettings").click(function() {
		$("#loading").html("<img src='images/loaders/loader12.gif'>");
		
		var settings = {};
		
		$("input").each(function(index, value) {			
			settings[$(this).attr('id')] = $(this).attr('value');	
			console.log($(this).attr('id') +':'+ $(this).attr('value'));		
		});
		settings['appid'] = "VetPatholator";
		...
		$.ajax({
			...
			success: function() {
				$("#loading").html("<div class='nNote nSuccess hideit'><p><strong>DONE: </strong>Settings Saved!</p></div>");
			}
		});
		
	});

	$("#sendApplePush").click(function() {
		
		//var pushData = { pushmessage: [
		  //{message: "this is a message", badgeNumber: "2", actionText: "Buy Now!", deviceID: "ea69617d0b24f5d9e42bf4b071fb7c6c68b4892392aa981a84a12459e1ce73d4" },
		  //{message: "message # 2", badgeNumber: "1", actionText: "View Special Offers", deviceID: "44ba2a612ab57f1c7d16cecf90ec0214dfc12acaafa8e7ddac916f326c04fd87" }
		//]};
		
		$("#loading").html("<img src='images/loaders/loader12.gif'>");
		
		var pushData = { message: $('#pushMessage').val(), actionText: $('#actionText').val(), appid: $('#appID').val() };
		...
		$.ajax({
			...
			success: function() {
				//alert("Success! ");
				//$("#loading").html("<h4>Push Messages Sent!</h4>");
				$("#loading").html("<div class='nNote nSuccess hideit'><p><strong>SUCCESS: </strong>Push Messages Sent!</p></div>");
			}
		});
	});
	
	$("#sendGooglePush").click(function() {
