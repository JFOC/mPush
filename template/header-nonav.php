...
<div id="rightSide">
    ...
    <div class="topNav">
        <div class="wrapper">
            <div class="welcome"><a href="#" title=""><img src="images/userPic.png" alt="" /></a><span>Hello, Admin!</span></div>
            <div class="userNav">
                <ul>
                
                <li class="dd"><a title=""><img src="images/icons/light/computer.png" alt="" /><span>My Apps</span></a>
     ...
     <!--   <li class="charts"><a href="stats.php?appid=<?php echo $appid; ?>" title="" <?php if ($page=='stats.php') echo 'class="active"'; ?>><span>Statistics and charts</span></a></li> -->
        ...
        <li class="pushnotifications"><a href="#" title="" <?php if ($page=='pushapple.php' || $page=='pushgoogle.php') echo 'class="active exp" id="current"'; ?>class="exp"><span>Push Notifications</span><strong>2</strong></a>
            <ul class="sub">
                ...
                <li <?php if ($page=='pushgoogle.php') echo 'class="this last"'; echo 'class="last"'; ?>class="last"><a href="pushgoogle.php?appid=<?php echo $appid; ?>" title="Send to Android Devices">Google (Android)</a></li>
            </ul>
        </li>
